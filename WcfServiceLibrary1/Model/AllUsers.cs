...
namespace Model
{
    ...
    public class AllUsers : List<UserInfo>
    {
        ...
        public UserInfo AddUser(string name, string password, string email, string phone, bool admin, string teacherId = "")
        {
            ...
            {
                this.Add(new UserInfo { Username = name, Password = password, Email = email, Phone = phone, IsAdmin = admin, TeacherId = int.Parse(teacherId) });
            }
